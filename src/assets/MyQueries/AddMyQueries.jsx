    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex justify-center py-10 px-6">
        <div className="grid lg:grid-cols-2 items-center gap-10 max-w-6xl max-lg:max-w-lg w-full p-6">
          {/* Left Side Info */}
          <div>
            <h1 className="lg:text-5xl text-4xl font-bold text-gray-900 dark:text-white leading-tight">
              Add a Product Query Privately
            </h1>
            <p className="text-[15px] mt-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          >
            <h2 className="text-gray-900 dark:text-white text-3xl font-semibold mb-8">
              Add Query
            </h2>
            ...
            <div className="space-y-6">
              {/* Product Name */}
              <div>
                <label className="text-sm text-gray-900 dark:text-gray-200 font-medium mb-2 block">
                  Product Name
                </label>
                <input
                  name="productName"
                  type="text"
                  required
                  className="bg-gray-100 dark:bg-gray-700 dark:text-white w-full text-sm px-4 py-3 rounded-md border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-teal-500"
